...
class Config:
    ...
    biobtree_timeout: float = 180.0  # 3 minutes - balance between complex queries and responsiveness
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            biobtree_timeout=float(os.getenv("BIOBTREE_TIMEOUT", "180.0")),  # 3 minutes
            ...
            chat_max_iterations=int(os.getenv("BIOBTREE_CHAT_MAX_ITERATIONS", "40")),
