...
var file_app_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xfb, 0x08, 0x0a, 0x04, 0x58, 0x72,
	...
	0x28, 0x09, 0x52, 0x05, 0x70, 0x61, 0x67, 0x65, 0x73, 0x22, 0x45, 0x0a, 0x09, 0x58, 0x72, 0x65,
...
var file_app_proto_depIdxs = []int32{
	...
	20, // 26: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 27: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 28: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 29: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 30: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 31: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 32: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 33: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 34: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 35: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 36: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 37: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 38: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 39: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 40: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 41: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 42: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 43: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 44: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
