...
var file_app_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xb3, 0x0b, 0x0a, 0x04, 0x58, 0x72,
	...
	0x63, 0x65, 0x6e, 0x74, 0x72, 0x61, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74,
...
var file_app_proto_depIdxs = []int32{
	...
	20, // 31: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 32: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 33: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 34: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 35: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 36: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 37: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 38: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 39: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 40: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 41: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 42: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 43: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 44: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 45: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 46: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 47: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 48: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 49: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
