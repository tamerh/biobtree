...
var file_app_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0x97, 0x0c, 0x0a, 0x04, 0x58, 0x72,
	...
	0x52, 0x09, 0x6c, 0x69, 0x70, 0x69, 0x64, 0x6d, 0x61, 0x70, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x63,
...
var file_app_proto_depIdxs = []int32{
	...
	20, // 33: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 34: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 35: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 36: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 37: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 38: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 39: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 40: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 41: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 42: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 43: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 44: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 45: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 46: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 47: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 48: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 49: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 50: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 51: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
