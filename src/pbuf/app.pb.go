...
var file_app_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xbf, 0x09, 0x0a, 0x04, 0x58, 0x72,
	...
	0x61, 0x6c, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x14, 0x20, 0x01,
...
var file_app_proto_depIdxs = []int32{
	...
	20, // 27: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 28: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 29: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 30: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 31: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 32: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 33: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 34: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 35: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 36: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 37: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 38: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 39: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 40: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 41: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 42: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 43: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 44: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 45: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
