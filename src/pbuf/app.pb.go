...
var file_app_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xfa, 0x09, 0x0a, 0x04, 0x58, 0x72,
	...
	0x48, 0x00, 0x52, 0x0a, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x61, 0x74, 0x74, 0x72, 0x12, 0x14,
	...
	0x09, 0x52, 0x05, 0x70, 0x61, 0x67, 0x65, 0x73, 0x22, 0x61, 0x0a, 0x09, 0x58, 0x72, 0x65, 0x66,
...
var file_app_proto_depIdxs = []int32{
	...
	20, // 28: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 29: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 30: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 31: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 32: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 33: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 34: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 35: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 36: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 37: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 38: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 39: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 40: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 41: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 42: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 43: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 44: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 45: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 46: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
