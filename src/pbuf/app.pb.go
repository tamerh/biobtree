...
var file_app_proto_rawDesc = []byte{
	...
	0x58, 0x72, 0x65, 0x66, 0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xcf, 0x0e,
	...
	0x41, 0x74, 0x74, 0x72, 0x48, 0x00, 0x52, 0x06, 0x69, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x12, 0x27,
...
var file_app_proto_depIdxs = []int32{
	...
	54, // 39: pbuf.Xref.dbsnp:type_name -> pbuf.DbsnpAttr
	20, // 40: pbuf.Xref.entries:type_name -> pbuf.XrefEntry
	21, // 41: pbuf.Xref.dataset_counts:type_name -> pbuf.XrefDomainCount
	25, // 42: pbuf.Xref.datasetPages:type_name -> pbuf.Xref.DatasetPagesEntry
	12, // 43: pbuf.MetaResponse.ResultsEntry.value:type_name -> pbuf.MetaKeyValue
	19, // 44: pbuf.Xref.DatasetPagesEntry.value:type_name -> pbuf.PageInfo
	0,  // 45: pbuf.BiobtreeService.Search:input_type -> pbuf.SearchRequest
	2,  // 46: pbuf.BiobtreeService.Mapping:input_type -> pbuf.MappingRequest
	4,  // 47: pbuf.BiobtreeService.Entry:input_type -> pbuf.EntryRequest
	6,  // 48: pbuf.BiobtreeService.Page:input_type -> pbuf.PageRequest
	8,  // 49: pbuf.BiobtreeService.Filter:input_type -> pbuf.FilterRequest
	10, // 50: pbuf.BiobtreeService.Meta:input_type -> pbuf.MetaRequest
	13, // 51: pbuf.BiobtreeService.ListGenomes:input_type -> pbuf.ListGenomesRequest
	1,  // 52: pbuf.BiobtreeService.Search:output_type -> pbuf.SearchResponse
	3,  // 53: pbuf.BiobtreeService.Mapping:output_type -> pbuf.MappingResponse
	5,  // 54: pbuf.BiobtreeService.Entry:output_type -> pbuf.EntryResponse
	7,  // 55: pbuf.BiobtreeService.Page:output_type -> pbuf.PageResponse
	9,  // 56: pbuf.BiobtreeService.Filter:output_type -> pbuf.FilterResponse
	11, // 57: pbuf.BiobtreeService.Meta:output_type -> pbuf.MetaResponse
	14, // 58: pbuf.BiobtreeService.ListGenomes:output_type -> pbuf.ListGenomesResponse
