...
# mapping configs ship inside the package; resolve relative to it so the defaults
# work regardless of the current working directory.
_MAP = Path(__file__).resolve().parent / "mappings"
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        "--categories", default=str(_MAP / "categories.yaml"), help="category map"
    )
    ...
    e.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    e.add_argument("--predicates", default=str(_MAP / "predicates.yaml"))
    ...
    r.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    r.add_argument("--predicates", default=str(_MAP / "predicates.yaml"))
    ...
    g.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    rs.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    db.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    me.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    on.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    st.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    ...
    na.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    na.add_argument("--config", default=str(_MAP / "node_attributes.yaml"), help="node-attributes config")
    ...
    at.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    at.add_argument("--config", default=str(_MAP / "attributes.yaml"), help="node-attributes config")
    ...
    sh.add_argument("--categories", default=str(_MAP / "categories.yaml"))
    sh.add_argument("--config", default=str(_MAP / "showcase.yaml"), help="showcase gene/compound lists")
    ...
    sg.add_argument("--config", default=str(_MAP / "subgraph.yaml"))
    ...
    a.add_argument("--categories", default=str(_MAP / "categories.yaml"))
