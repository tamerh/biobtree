...
build drift check: run it after BioBTree changes; new datasets surface here.
    ...
    python -m kg_export.coverage_audit [--conf <dir>] [--quiet]
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--categories", default=str(Path(__file__).resolve().parent / "mappings" / "categories.yaml"))
    ap.add_argument("--predicates", default=str(Path(__file__).resolve().parent / "mappings" / "predicates.yaml"))
    ap.add_argument("--skip", default=str(Path(__file__).resolve().parent / "mappings" / "coverage_skip.yaml"))
    ap.add_argument("--attributes", default=str(Path(__file__).resolve().parent / "mappings" / "attributes.yaml"))
