"""General node-attribute layer tests (entry attrs -> node properties).
    ...
    python3 -m unittest kg_export.tests.test_nodeattrs -v
"""
...
from kg_export.nodeattrs import build_node_attributes
...
class NodeAttrTests(unittest.TestCase):
    ...
    def test_synonyms_union_across_datasets_at_merge(self):
        ...
        from kg_export.attributes import merge_attr_dict
        dst = {}
