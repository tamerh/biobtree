"""Tests for code-review fixes (resilience, CURIE safety, cross-chunk reified).
    ...
    python3 -m unittest kg_export.tests.test_review_fixes -v
"""
...
from kg_export.curie import to_curie
from kg_export.datasets import DatasetRegistry
from kg_export.index import iter_index_file
from kg_export.nodes import tsv_safe
