...
func (s *Service) initWithDbDir(dbDir string) error {
	...
	s.celgoEnv, err = cel.NewEnv(
		...
		cel.Types(&pbuf.FaersReactionAttr{}),
		...
		cel.Declarations(
			decls.NewIdent("clingen_gene_validity", decls.NewObjectType("pbuf.ClingenGeneValidityAttr"), nil)),
		cel.Declarations(
		...
		cel.Declarations(
			decls.NewIdent("faers_reaction", decls.NewObjectType("pbuf.FaersReactionAttr"), nil)),
		cel.Declarations(
