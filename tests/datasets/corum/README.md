...
# Filtered queries
biobtree query "P04637 >> uniprot >> corum[corum.organism==\"Human\"]"
biobtree query "P04637 >> uniprot >> corum[corum.subunit_count>5]"
biobtree query "P04637 >> uniprot >> corum[corum.has_drug_targets==true]"
```
