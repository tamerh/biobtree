#!/usr/bin/env python3
"""
DIAMOND Similarity Dataset Tests
...
class DiamondSimilarityTests:
    """DIAMOND Similarity custom tests (in addition to declarative tests)"""
    ...
    def test_protein_has_similarities(self):
        ...
        attrs = result.get("Attributes", {}).get("DiamondSimilarity", {})
...
def main():
    ...
    # Add custom tests
    custom_tests = DiamondSimilarityTests(runner)
    for test_method in [
