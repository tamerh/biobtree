#!/usr/bin/env python3
"""
EnsemblBacteria Gene Test Suite

Tests ensembl_bacteria dataset processing using the common test framework.
...
def main():
    ...
    # Add custom tests
    custom_tests = EnsemblBacteriaTests(runner)
    for test_method in [
