#!/usr/bin/env python3
"""
EnsemblFungi Gene Test Suite

Tests ensembl_fungi dataset processing using the common test framework.
...
def main():
    ...
    # Add custom tests
    custom_tests = EnsemblFungiTests(runner)
    for test_method in [
