...
```
curl "http://localhost:9292/ws/map/?i=hsa-miR-21-5p&m=>>mirdb[mirdb.target_count>500]"
```

### Filter by score
```
curl "http://localhost:9292/ws/map/?i=hsa-miR-21-5p&m=>>mirdb[mirdb.max_score>90.0]"
```
