#!/usr/bin/env python3
"""
EnsemblMetazoa Gene Test Suite

Tests ensembl_metazoa dataset processing using the common test framework.
...
def main():
    ...
    # Add custom tests
    custom_tests = EnsemblMetazoaTests(runner)
    for test_method in [
