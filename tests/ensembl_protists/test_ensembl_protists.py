#!/usr/bin/env python3
"""
EnsemblProtists Gene Test Suite

Tests ensembl_protists dataset processing using the common test framework.
...
def main():
    ...
    # Add custom tests
    custom_tests = EnsemblProtistsTests(runner)
    for test_method in [
