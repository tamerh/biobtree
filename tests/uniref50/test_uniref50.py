...
Tests UniRef50 dataset processing using the common test framework.
...
class UniRef50Tests:
    """UniRef50 custom tests (in addition to declarative tests)"""
    ...
    def test_entry_has_name(self):
        """Check UniRef50 entry has cluster name"""
...
def main():
    ...
    # Add custom tests
    custom_tests = UniRef50Tests(runner)
