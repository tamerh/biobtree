...
Tests UniRef90 dataset processing using the common test framework.
...
class UniRef90Tests:
    """UniRef90 custom tests (in addition to declarative tests)"""
    ...
    def test_entry_has_name(self):
        """Check UniRef90 entry has cluster name"""
...
def main():
    ...
    # Add custom tests
    custom_tests = UniRef90Tests(runner)
