    ...
    <div>
      <div class="xrefs" v-show="sub_res.showResults">
        ...
        <div class="allEntryBox">
          ...
          <div v-show="!sub_res.Attributes.Empty"><p><strong>Attributes</strong></p><vue-json-pretty :path="'res'" :data="sub_res.Attributes" :showDoubleQuotes="false" :deep=3></vue-json-pretty></div>

          <p><strong>Mapped references</strong></p>
  ...
  methods: {
    ...
    selectXref: function (id, domain_id, entry_id, entry_domain_id, sub_res, entry) {
      ...
      this.$root.$data.fetcher.searchEntry(
        entry_id,
        this.xref_conf[entry_domain_id].id,
