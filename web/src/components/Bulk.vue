<template>
  <div class="hero-body is-fullheight" v-show="bulkActive">
    <div class="container">
      ...
      <div>
        <div class="columns">
          ...
          <div class="column is-two-fifths" style="display:none">
          ...
          <div class="column is-pulled-right">
            <button class="button is-warning" style="margin-top:30px" @click="upload">Start</button>
          </div>
        </div>
      </div>
    </div>
